...
import { SectionMatchesList } from './section-matches-list'
...
export function SimilarityResultsV2({ results, sourceDocument, isLoading }: SimilarityResultsV2Props) {
  ...
  const [selectedResult, setSelectedResult] = useState<SimilarityResultV2 | null>(null)
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {result.sections.length > 0 && (
                      <div className="border-t pt-4">
                        ...
                        <SectionMatchesList sections={result.sections} />
                      </div>
                    )}
